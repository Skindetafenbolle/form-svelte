let ru = {
	...
	form: {
		...
		preference: {
			text: 'Выберите к какой категории соответствует ваша компания (можно выбрать несколько вариантов):'
		},
		confirmation: {
			text: 'Даю согласие на публикацию предоставленных данных на ресурсах YOOHIVE.COM (бот, сайт, соцсети)'
		},
		button: {
			text: 'Регистрация'
		}
